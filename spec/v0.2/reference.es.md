# Referencia de campos — OTE Spec 0.2.0
...
| --- | --- | :---: | --- | --- |
| `specVersion` | const: "0.2.0" | **sí** | Versión de OTE Spec a la que se adhiere el documento. | `"0.2.0"` |
...
| Campo | Tipo | Oblig. | Descripción | Ejemplos |
| --- | --- | :---: | --- | --- |
| `specVersion` | const: "0.2.0" | **sí** | Versión de OTE Spec a la que se adhiere el feed. Aplica a todos sus eventos. | `"0.2.0"` |
