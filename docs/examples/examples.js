...
(function () {
  ...
  var UI = {
    en: {
      ...
      lead: "The reference tells you what each field is. This page shows you whole documents: what a small meetup looks like, what changes when it repeats every month, and what to do with a course spread over three Saturdays. Copy any of them.",
    ...
    es: {
      ...
      lead: "La referencia te dice qué es cada campo. Esta página te enseña documentos enteros: cómo se ve un meetup pequeño, qué cambia cuando se repite todos los meses, y qué hacer con un curso repartido en tres sábados. Cópialos.",
